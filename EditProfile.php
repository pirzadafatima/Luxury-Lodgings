    ...
    <div class="container">
        <div class="row">
                <div class="col-12">
                    ...
                    <!-- Form START -->
                    <form class="file-upload" form action="EditProfile.php" method ="Post">
                                ...
                                <div class="bg-secondary-soft px-4 py-5 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="CNIC" aria-label="Phone number" value="<?php echo $cnic?>">
                                        </div>
                                        <!-- Mobile number -->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="DOB" aria-label="Phone number" value="1970-11-23">
                                        </div>
                                    </div> <!-- Row END -->
                                </div>
                            </div>
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "Update [Guests] set [First Name] = '$FName', [Last Name] = '$LName', [CNIC] = '$cnic', [DOB] = '$DOB', 
        [Email ID] = '$mail', [Phone Number] = '$No' where Username = '$uname' ";
        $result = sqlsrv_query($conn, $sql);
        ...
        if($NPass)
        {
            ...
            {
                $sql2 = "Update [Guests] set [Password] = '$NPass' where Username = '$uname' ";
